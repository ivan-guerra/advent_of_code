    ...
    for (int i = 0; i < kNumIngredients; ++i) {
        for (int j = 0; j < (kNumIngredients - i); ++j) {
            for (int k = 0; k < (kNumIngredients - i - j); ++k) {
                ...
                int capacity = (ingredients[0].capacity * i) +
                               (ingredients[1].capacity * j) +
                               (ingredients[2].capacity * k) +
                               (ingredients[3].capacity * h);
                int durability = (ingredients[0].durability * i) +
                ...
                int texture = (ingredients[0].texture * i) +
