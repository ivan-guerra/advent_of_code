...
class ISchemaStateFactory {
 public:
  ...
  virtual ISchemaValidator* CreateSchemaValidator(
      const SchemaType&, const bool inheritContinueOnErrors) = 0;
...
class Schema {
 public:
  ...
  static const ValueType& GetValidateErrorKeyword(
...
class GenericSchemaDocument {
  ...
  */
  ...
  static const StringRefType& GetSchemaErrorKeyword(
    ...
    if (doc.GetType() == kObjectType) {
      ...
      if (localuri.Match(finduri, full)) {
        RAPIDJSON_SCHEMA_PRINT(
            Method, "GenericSchemaDocument::FindId (match)",
...
class GenericSchemaValidator : public internal::ISchemaStateFactory<
  ...
  */
  ...
  void AboveMaximum(int64_t actual, const SValue& expected, bool exclusive) {
    AddNumberError(
        exclusive ? kValidateErrorExclusiveMaximum : kValidateErrorMaximum,
  ...
  void BelowMinimum(int64_t actual, const SValue& expected, bool exclusive) {
    AddNumberError(
        exclusive ? kValidateErrorExclusiveMinimum : kValidateErrorMinimum,
        ValueType(actual).Move(), expected,
...
#undef RAPIDJSON_SCHEMA_HANDLE_VALUE_
  ...
  virtual ISchemaValidator* CreateSchemaValidator(
      const SchemaType& root, const bool inheritContinueOnErrors) {
    *documentStack_.template Push<Ch>() = '\0';
    documentStack_.template Pop<Ch>(1);
    ISchemaValidator* sv =
 ...
 private:
  ...
  void AddNumberError(
      const ValidateErrorCode code, ValueType& actual, const SValue& expected,
