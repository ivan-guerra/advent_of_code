...
int GetMinPathLen(int target_steps, int designer_num) {
...
int main(int argc, char** argv) {
    ...
    const int kTargetSteps = 50;
    std::cout << "Answer: "
              << GetMinPathLen(kTargetSteps, std::stoi(designer_num))
              << std::endl;
